...
public class ParkingInfoForm extends javax.swing.JFrame {
    ...
    static DB db = new DB();
    static Admin admin;
    public ParkingInfoForm(Admin admin) {
        initComponents();
        this.setExtendedState(MAXIMIZED_BOTH);
        this.setVisible(true);
        this.admin = admin;
        setTitle("Quản lí thông tin bãi đỗ - " + admin.name);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Thông tin các bãi xe");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParkingInfoForm(admin).setVisible(true);
            }
        });
    }
    ...
    //Load bảng parking info vào từ DB
        ArrayList<ArrayList<String>> parkingInfo = this.admin.getParkingInfo();
   ...
   public void capNhatBaiDo(){
        ...
        if(this.admin.updateParkingInfo(parking_id, parking_name,parking_address,parking_capacity,type_vehicle,over_night )) {JOptionPane.showMessageDialog(null, "Cập nhật thông tin bãi đỗ thành công");this.loadTableParkingInfo();}
